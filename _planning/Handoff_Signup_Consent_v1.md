...
**전체 동의 항목**: 전체 동의 (가입 카피 키)

**필수 동의 항목 3종** (체크 안 하면 가입 완료 불가):
- [필수] 이용약관 동의 (가입 카피 키)
- [필수] 개인정보 수집·이용 동의 (가입 카피 키)
- [필수] 만 14세 이상이에요 (가입 카피 키)

**만 14세 안내 문구** (가입 카피 키)
> Artier는 만 14세 미만 회원 가입을 받지 않습니다. (전자상거래 등에서의 소비자보호에 관한 법률 등 준수)

**선택 동의 항목** (기본 OFF):
- [선택] 마케팅 정보 수신 동의 (가입 카피 키)
...
**Section header**: Terms & consent (가입 카피 키)

**Agree all toggle**: Agree to all (가입 카피 키)

**Required (3)** — must check all to complete signup:
- [Required] Terms of service (가입 카피 키)
- [Required] Privacy policy (가입 카피 키)
- [Required] I am 14 years or older (가입 카피 키)

**Age restriction notice** (가입 카피 키)
> Artier does not allow accounts for users under 14 (consumer protection and related regulations).

**Optional** (default OFF):
- [Optional] Receive marketing messages (가입 카피 키)

**Optional hint** (가입 카피 키)
...
`{provider}` placeholder는 소셜 가입 카피 키(카카오) / 소셜 가입 카피 키(구글) / 소셜 가입 카피 키(Apple)로 치환.
...
**닉네임 입력**
- 라벨: 닉네임 (소셜 가입 카피 키)
- 플레이스홀더: 예) 카테, 봄날의 화가 (소셜 가입 카피 키)
- 보조 설명: 2~20자. 가입 후 프로필에서 변경할 수 있어요. (소셜 가입 카피 키)

**전체 동의**: 전체 동의 (선택 항목 포함) (소셜 가입 카피 키)

**필수 동의 3종**:
- [필수] 이용약관 동의 (소셜 가입 카피 키)
- [필수] 개인정보 수집·이용 동의 (소셜 가입 카피 키)
- [필수] 만 14세 이상이에요 (소셜 가입 카피 키)

**선택 동의** (기본 OFF):
- [선택] 마케팅 정보 수신 동의 (소셜 가입 카피 키)
- 보조 설명: 이메일·알림톡·문자 중 보유한 채널로 보내드려요. (소셜 가입 카피 키)
...
`{provider}` is replaced by 소셜 가입 카피 키(Kakao) / 소셜 가입 카피 키(Google) / 소셜 가입 카피 키(Apple).

**Guide** (소셜 가입 카피 키)
> Your {provider} account has been verified. Enter a nickname and agree to the terms to complete signup.

**Nickname field**
- Label: Nickname (소셜 가입 카피 키)
- Placeholder: e.g. Carte, Spring Painter (소셜 가입 카피 키)
- Hint: 2–20 characters. You can change this later in your profile. (소셜 가입 카피 키)

**Agree all**: Agree to all (including optional) (소셜 가입 카피 키)

**Required (3)**:
- [Required] Agree to Terms of Service (소셜 가입 카피 키)
- [Required] Agree to Privacy Policy (소셜 가입 카피 키)
- [Required] I am 14 years or older (소셜 가입 카피 키)

**Optional** (default OFF):
- [Optional] Agree to receive marketing (소셜 가입 카피 키)
- Hint: We'll use whichever channel you have — email, KakaoTalk, or SMS. (소셜 가입 카피 키)
...
### 4.1 이메일 가입 Step 3
- 섹션·전체: 가입 카피 키, 가입 카피 키
- 필수: 가입 카피 키, 가입 카피 키, 가입 카피 키
- 14세 안내: 가입 카피 키
- 선택: 가입 카피 키, 가입 카피 키
- 태그: 가입 카피 키(`[필수]`), 가입 카피 키(`[선택]`)
- 보기 버튼: 가입 카피 키

### 4.2 소셜 가입 모달
- 헤더·가이드: 소셜 가입 카피 키, 소셜 가입 카피 키
- 제공자: 소셜 가입 카피 키 / 구글 가입 카피 키 / 애플 가입 카피 키
- 닉네임: 소셜 가입 카피 키, 내부 식별자, 내부 식별자
- 동의: 소셜 가입 카피 키, 내부 식별자, 내부 식별자, 내부 식별자, 내부 식별자, 내부 식별자
- 버튼: 소셜 가입 카피 키, 소셜 가입 카피 키
