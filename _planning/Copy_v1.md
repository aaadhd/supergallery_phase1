...
/demo/reference|모의 JWT·이메일 템플릿·발송 조건 표`,
  ...
  'upload.eventConsentLabel': '선정 시 결과 페이지에 일정 기간 게시되며, 전시 삭제 후에도 해당 기간까지 운영팀 사본이 유지될 수 있음에 동의합니다.',
  ...
  'review.notifSubmitted': '\'{title}\' 전시가 검수에 들어갔어요. 결과는 알림으로 알려드릴게요.',
  ...
  'upload.publishedConfirmDescPending': '지금 검수 중이에요. 결과는 알림으로 알려드릴게요. 검수를 통과하면 둘러보기·검색에서 보여요.',
  ...
  'upload.publishedConfirmSlaNote': '결과(승인·반려)는 알림 센터와 가입 시 등록한 채널로 전달돼요.',
  ...
  'faq.a9':
    '전시 상세 화면에서 신고 버튼(깃발 아이콘)을 눌러 신고할 수 있어요. 운영팀이 확인해드려요.',
  ...
  'profile.publishedBannerDesc': '운영팀이 검수를 마친 뒤 둘러보기에 공개돼요. 검수 중에는 배지로 상태를 확인할 수 있고, 공개되면 알림으로 알려드려요.',
...
/demo/reference|Mock JWT, email templates, send-rule table`,
  ...
  'events.notifyModalLead':
    'We use your email to manage this subscription. Kakao sign-ups get Alimtalk/SMS first; other sign-up methods mainly get email.',
  ...
  'events.notifyErrEmpty': 'Please enter your email',
  'events.notifyErrInvalid': 'That does not look like a valid email',
  'events.notifyDuplicate': 'You are already subscribed',
  'events.notifyToastSubscribed': 'Subscription saved',
  'events.unsubscribeLink': 'Unsubscribe',
  'events.unsubscribeModalTitle': 'Unsubscribe from event emails',
  'events.unsubscribeModalLead': 'Enter the email you subscribed with to remove it from the list.',
  'events.unsubscribeSubmit': 'Unsubscribe',
  'events.unsubscribeDoneTitle': 'Unsubscribed',
  'events.unsubscribeDoneLead': 'We will no longer send event updates to this address.',
  'events.unsubscribeToastDone': 'You have been unsubscribed',
  'events.unsubscribeNotFound': 'No subscription found for that email',
  'events.switchToUnsubscribe': 'Unsubscribe instead?',
  'events.switchToSubscribe': 'Back to subscribe',
  ...
  'upload.eventConsentLabel': 'I agree that if selected, my work may be displayed on the results page for a set period, and the team may retain a copy until the end of that period even if I delete the exhibition.',
  ...
  'settings.eventUnsubscribeLabel': 'Unsubscribe from event emails',
  'settings.eventUnsubscribeHint': 'Open the Events page to unsubscribe with your email.',
