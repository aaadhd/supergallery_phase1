...
/demo/reference|모의 JWT·이메일 템플릿·발송 조건 표`,
  ...
  'events.notifyCta': '알림 받기',
  'events.notifySubscribed': '알림 해지',
  ...
  'events.curationViewPage': '페이지 보기',
...
/demo/reference|Mock JWT, email templates, send-rule table`,
  ...
  'events.tabPick': 'Pick',
  'events.tabCuration': 'Curated',
  'events.viewResult': 'See results',
  'events.notifyCta': 'Get notified',
  'events.notifySubscribed': 'Unsubscribe',
  'events.pickNoActive': 'No active Pick right now',
  'events.pickViewSelected': 'View selected exhibitions',
  'events.curationActive': 'On now',
  'events.curationEnded': 'Past exhibitions',
  'events.curationNone': 'No curated exhibitions right now',
  'events.curationEndedBlocked': 'This exhibition has ended',
  'events.curationPieces': '{n} works',
  'events.curationViewPage': 'View page',
