...
/demo/reference|모의 JWT·이메일 템플릿·발송 조건 표`,
  ...
  'faq.a3':
    '탈퇴하면 업로드한 전시가 모두 삭제돼요. 복구할 수 없으니 탈퇴 전에 남기고 싶은 작품은 따로 저장해 주세요.',
...
/demo/reference|Mock JWT, email templates, send-rule table`,
  ...
  'settings.withdrawBody':
    'This cannot be undone. Your uploaded exhibitions will be deleted. Your account, likes, and follows will be removed.',
