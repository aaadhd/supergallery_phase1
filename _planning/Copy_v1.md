...
/demo/reference|모의 JWT·이메일 템플릿·발송 조건 표`,
  ...
  'upload.soloSuggestionDesc': '현재 등록된 작가가 1명뿐이에요. 개인 전시로 전환하는 것이 더 적합해요.',
...
/demo/reference|Mock JWT, email templates, send-rule table`,
  ...
  'upload.errMustIncludeSelf': 'Include at least one of your own works.',
  ...
  'upload.soloSuggestionDesc': 'Only one artist is assigned. A solo exhibition may be a better fit.',
