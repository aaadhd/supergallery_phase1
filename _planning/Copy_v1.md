...
(토큰은 마이페이지 "비회원 작가에게 알리기" 버튼에서 생성. 친구가 가입하면 본인 작품 찾기 화면으로 자동 진입)`,
...
/demo/reference|모의 JWT·이메일 템플릿·발송 조건 표`,
  ...
  'search.groupsHeading': '그룹 ({n})',
  'search.exhibitionsHeading': '전시 ({n})',
  ...
  'admin.curation.subtitle': '기획전은 기획전 페이지에서만 노출됩니다. 일반 피드 부스트 대상이 아닙니다.',
  ...
  'admin.contest.publicationOpenLabel': '선정작 발표 페이지를 사용자에게 게시',
...
/demo/reference|Mock JWT, email templates, send-rule table`,
  ...
  'search.worksHeading': 'Work titles ({n})',
  ...
  'search.groupsHeading': 'Groups ({n})',
  'search.exhibitionsHeading': 'Exhibitions ({n})',
  ...
  'events.badge': 'EVENT',
  'events.viewDetail': 'See details',
  'events.endedSection': 'Past events',
  'events.endedBadge': 'Ended',
