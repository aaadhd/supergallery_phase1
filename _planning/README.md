...
| **참여 작가** | 함께 올리기(그룹 전시)에서 같이 올라간 작가 | ~~참가자~~ |
...
| **함께 올리기** | 여러 작가가 같이 올리는 그룹 전시. 전시에 등장하는 서로 다른 작가 2명 이상 필수. 게시자 본인 작품 포함 시 타인 1명 이상, 미포함 시 타인 2명 이상. | ~~그룹 업로드~~ |
