...
| 버전 | 일자 | 작성 | 변경 내용 |
|------|------|------|----------|
| v1.14 | 2026-05-09 | PM × Claude | 검수 상태 5종→4종, 함께 올리기 조건 명확화, 링크 공유 카드 수정; 충돌 방지 구조표 알림 10→13종(신고 처리 작가 수신 3종 추가, 신고자 기각 알림 제거); 충돌 방지 구조표 "그룹 초대"→"그룹 전시 게시", "초대"→"작품 연결" 정정 |
