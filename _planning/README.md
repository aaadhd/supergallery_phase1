...
| **알림 종류 10종 + UI 매트릭스** (icon·color·메시지 템플릿. 토글 가능 5종(좋아요·팔로우·그룹 초대·기획전·Pick·마케팅) + 시스템 강제 4종) | `PRD_User_v1.md` USR-NTF-01 매트릭스 | Handoff_Notifications는 prose 인용 |
...
| 버전 | 일자 | 작성 | 변경 내용 |
|------|------|------|----------|
| v1.14 | 2026-05-09 | PM × Claude | 검수 상태 5종→4종, 함께 올리기 조건 명확화, 링크 공유 카드 수정; 충돌 방지 구조표 알림 토글 4→5종 정합 |
