...
| 항목 | 결정 | 근거 |
|---|---|---|
| 일반 문의 SLA | **영업일 5일** 이내 응답 | [Policy §30.0](./Policy_v1.md#30-0-문의-채널-sla-통합-정리-참고) |
| 개인정보 권리 행사 SLA | 접수 5영업일 + 처리 30일 (1회 연장) | [Policy §30.3](./Policy_v1.md#30-3-처리-기한-sla) |
| 첨부 파일 | 최대 3개, 각 5MB 이하 | 운영 보안 정책 |
| 본인 확인 | 로그인 상태는 세션 1차 확인. 비로그인·탈퇴자는 가입 이메일에서 회신 | [Policy §30.4](./Policy_v1.md#30-4-본인-확인) |
