...
#### Q7. 그룹 전시는 어떻게 만드나요?
업로드할 때 "여러 작가 함께 올리기"를 선택하면 그룹명을 입력하고 참여 작가를 한 자리씩 추가할 수 있어요. Proud Gallery 회원이면 이름을 검색해 바로 연결되고, 회원이 아닌 분은 이름만 입력해 자리를 만들어 두면 검수 통과 후 초대 링크로 직접 알릴 수 있어요.
...
| 버전 | 일자 | 작성 | 변경 내용 |
|------|------|------|----------|
| v7 | 2026-05-19 | PM × Claude | Q7 "함께 올리기"→"여러 작가 함께 올리기" |
