# 응모전 응모 동의 원고 v1 (변호사 검토용 초안)

**작성**: PM × Claude · **독자**: 변호사·DPO·개발(QA)

응모전 응모 모달([USR-EVT-04](./PRD_User_v1.md#usr-evt-04-응모전-응모-모달))에서 사용자에게 노출되는 **응모 동의 항목**의 한국어·영문 본문 단일 소스.

> **이 문서의 성격**
> - 본 원고는 **PM이 정리한 변호사 검토용 초안**이다. 법적 효력을 가지는 확정본이 아니다.
> - 정책 SSoT는 [Policy §15.5](./Policy_v1.md#15-5-응모전-선정-정책-런칭-전-필수)·[Policy §25.2](./Policy_v1.md#25-2-응모-조건)·[Policy §32.1](./Policy_v1.md#32-1-전시-삭제-시-정리-대상) #10. 본 문서는 화면 노출 문구·동의 범위·근거의 단일 소스.
> - 변호사 검토 포인트는 [Handoff_LegalReview §3 LP-11](./Handoff_LegalReview_Checklist_v1.md#lp-11-응모전-응모-시점-동의-게시-보존) 단일 소스.
> - 사용자 모집 시작 전 법무 확정본 게시 필수([Policy §21.0](./Policy_v1.md#21-0-법무-문서-단계별-마감-운영-가드)).
...
| 항목 | 결정 |
|---|---|
| 동의 시점 | **응모 시점** ([USR-EVT-04](./PRD_User_v1.md#usr-evt-04-응모전-응모-모달) 응모 모달의 발행 단계 — USR-UPL-02 일반 업로드는 응모 진입점이 아님) |
...
> **선정될 경우 응모전 결과·관련 페이지에 일정 기간 게시되며, 게시 기간 중 본 전시를 삭제해도 운영팀이 별도 보관한 사본으로 게시 기간 종료일까지 유지될 수 있음에 동의합니다.**
...
> 응모전에 응모하시려면 게시 보존 동의에 체크해 주세요.

### 2.4 동의 본문 (모달·약관 분기 시 게재)

**응모전 응모 동의 — 게시 보존**

본 전시를 본 응모전에 응모하시면, 운영팀이 응모작 중 일부를 선정해 응모전 결과 발표·관련 페이지·배너 등 Proud Gallery 사이트 내에 일정 기간 게시할 수 있습니다.

**1. 동의 시점·범위**
- 본 동의는 응모 시점에 효력을 갖습니다.
- 동의가 없으시면 본 응모전에 응모하실 수 없습니다.
- 다른 응모전으로의 응모·일반 업로드·공개·열람 등 다른 서비스 이용에는 영향이 없습니다.

**2. 게시 기간**
- 게시 기간은 응모전별로 운영팀이 정하며, 응모전의 공식 종료일을 기준으로 합니다.
- 게시 기간이 끝나면 별도 보관 사본도 자동으로 정리됩니다(영구 삭제).
...
- 다음 응모전 응모 시점부터는 변경된 동의 상태가 적용됩니다.

**5. 권리 침해 사유 즉시 제거**
- 본 작품이 저작권 침해·명예훼손·기타 법령 위반으로 신고·확인되면 본 동의와 관계없이 즉시 발표·사본 모두에서 제거됩니다.
- 본인 본의가 아닌 게시·악의적 도용 등이 의심되시면 [USR-INF-07](./PRD_User_v1.md#usr-inf-07-문의하기) 문의로 알려주시기 바랍니다.

**6. 동의 이력 보존**
- 본 작품이 응모전에 연결된 사실 자체가 응모 시점 동의의 증거로 갈음됩니다.
- 별도 동의 이력(작가 ID·전시 ID·응모전 ID·동의 시각)의 명시 보관은 백엔드 도입 후 도입을 검토하며, 보존 기간은 회사 약관·관련 법령에서 정하는 기간을 따릅니다.
...
By entering this exhibition into this event, you allow the team to select submissions and display them on the event results, related pages, and banners on Proud Gallery for a set period.
...
- If you believe a posting is unauthorized or maliciously misappropriated, please reach out via [USR-INF-07](./PRD_User_v1.md#usr-inf-07-문의하기) inquiries.
...
세부 검토 포인트는 [Handoff_LegalReview §3 LP-11](./Handoff_LegalReview_Checklist_v1.md#lp-11-응모전-응모-시점-동의-게시-보존) 단일 소스. 본 문서는 게재 문구만 다룬다.
...
- [ ] [USR-EVT-04](./PRD_User_v1.md#usr-evt-04-응모전-응모-모달) 응모 모달에 응모 동의 체크박스 노출 (CTA 위 인라인)
- [ ] 약관 보기 인라인 링크 → 본 §2.4 본문 게재(모달 또는 별도 페이지)
- [ ] 발행 검증 순서 #11에 미체크 에러 진입(첫 위반 지점에서 중단)
- [ ] ko/en 양측 동일 의미 노출
- [ ] 변호사 검토 결과(LP-11) 수령 후 §2.4·§3.4 본문 확정본 반영
- [ ] (백엔드 도입 후) 명시 CONSENT_LOG 저장 — 작가 ID·전시 ID·응모전 ID·동의 시각
...
| 버전 | 일자 | 작성 | 변경 내용 |
|------|------|------|----------|
| v3 | 2026-05-07 | PM × Claude | 응모 동의 본문 Artier→Proud Gallery 정합(KO·EN 각 1곳) |
...
[Handoff_LegalReview §3 LP-11]: Handoff_LegalReview_Checklist_v1.md#lp-11-응모전-응모-시점-동의-게시-보존
