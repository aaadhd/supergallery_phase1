...
> - 정책 SSoT는 [Policy §15.5](./Policy_v1.md#policy-15-5)·[Policy §25.2](./Policy_v1.md#policy-25-2)·[Policy §32.1](./Policy_v1.md#policy-32-1) #10. 본 문서는 화면 노출 문구·동의 범위·근거의 단일 소스.
> - 변호사 검토 포인트는 [Handoff_LegalReview §3 LP-11](./Handoff_LegalReview_Checklist_v1.md#lp-11-응모전-응모-시점-동의게시-보존) 단일 소스.
> - 사용자 모집 시작 전 법무 확정본 게시 필수([Policy §21.0](./Policy_v1.md#policy-21-0)).
...
세부 검토 포인트는 [Handoff_LegalReview §3 LP-11](./Handoff_LegalReview_Checklist_v1.md#lp-11-응모전-응모-시점-동의게시-보존) 단일 소스. 본 문서는 게재 문구만 다룬다.
...
[Handoff_LegalReview §3 LP-11]: Handoff_LegalReview_Checklist_v1.md#lp-11-응모전-응모-시점-동의게시-보존
