...
export const NOTICES: Notice[] = [
  {
    id: 'notice-1',
    title: 'Proud Gallery 그랜드 오픈 안내',
    titleEn: 'Proud Gallery Grand Opening',
    content:
      '안녕하세요, Proud Gallery 운영팀입니다.\n\n2026년 5월 15일, Proud Gallery가 그랜드 오픈합니다!\n\n그림을 그리는 누구나 작품을 올리고, 발견되고, 더 넓은 기회로 연결될 수 있는 디지털 아트 플랫폼 Proud Gallery에서 여러분의 작품을 세상과 공유해 보세요.\n\n런칭 기념 이벤트도 함께 진행되니 많은 참여 부탁드립니다.',
    contentEn:
      'Hello from the Proud Gallery team.\n\nOn May 15, 2026, Proud Gallery officially opens to everyone.\n\nProud Gallery is a digital art platform where anyone who creates can upload work, get discovered, and connect to new opportunities. Share your work with the world on Proud Gallery.\n\nWe are also running launch events—please join us.',
    isPinned: true,
  ...
  {
    id: 'notice-5',
    title: 'Proud Gallery 소프트 런칭 안내',
    titleEn: 'Proud Gallery Soft Launch (Partner Artists)',
    content:
