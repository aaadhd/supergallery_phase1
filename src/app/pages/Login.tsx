      ...
      <div className="w-full max-w-md">
        ...
        <div className="space-y-3">
          <Button
            ...
            variant="secondary"
            className={cn(
              'h-11 min-h-11 w-full gap-3 text-base font-medium',
              'border-0 bg-[#FEE500] text-[#3C1E1E] lg:hover:bg-[#FDD800]',
            )}
            onClick={handleSocialLogin}
          >
            <svg className="h-5 w-5" viewBox="0 0 24 24" aria-hidden>
              <path
                d="M12 3C6.5 3 2 6.6 2 11c0 2.8 1.9 5.3 4.7 6.7-.2.7-.7 2.6-.8 3 0 0 0 .1.1.1s.1 0 .2 0c.2 0 2.6-1.7 3.6-2.4.7.1 1.4.2 2.2.2 5.5 0 10-3.6 10-8S17.5 3 12 3z"
                fill="currentColor"
              />
            </svg>
            {t('login.kakao')}
          ...
          <Button
            type="button"
            variant="outline"
            className="h-11 min-h-11 w-full gap-3 text-base font-medium"
            onClick={handleSocialLogin}
          >
            <svg className="h-5 w-5" viewBox="0 0 24 24" aria-hidden>
              <path
          ...
          <Button
            type="button"
            className="h-11 min-h-11 w-full gap-3 bg-zinc-900 text-base font-medium text-white lg:hover:bg-zinc-800"
            onClick={handleSocialLogin}
          >
