    ...
    <div className="min-h-[70vh] flex flex-col items-center justify-center text-center px-6 pb-20 md:pb-0">
      ...
      <div className="flex gap-3">
        <button
          ...
          className="inline-flex items-center px-8 py-3.5 bg-white text-[#18181B] border border-[#D1D5DB] rounded-lg text-sm font-medium hover:bg-[#FAFAFA] transition-colors"
        >
          {t('error500.refresh')}
        </button>
        <Link
