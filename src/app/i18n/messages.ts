...
/demo/reference|모의 JWT·GeoIP·이메일 템플릿·발송 조건 표`,
  ...
  'login.regionSwitchToKr': '한국에 계신가요? 전화번호로 받기',
  'login.regionSwitchToIntl': '해외에서 가입하기',
  'settings.title': '설정',
  ...
  'review.editBannerRejected': '이 전시는 ‘{reason}’ 사유로 반려되었어요. 위 안내를 참고해 수정 후 다시 발행해 주세요.',
  'review.editBannerRejectedRepeated': '이 전시는 ‘{reason}’ 사유로 반려되었어요. 반복 반려: {n}회. 위 안내를 참고해 수정 후 다시 발행해 주세요.',
  ...
  'signup.linkSentSpam': '메일이 보이지 않으면 스팸함도 확인해 주세요.',
  ...
  'login.linkSentSpam': '메일이 보이지 않으면 스팸함도 확인해 주세요.',
...
/demo/reference|Mock JWT, GeoIP, email templates, send-rule table`,
  ...
  'login.tagline': 'Live Artfully',
  'login.regionSwitchToKr': 'In Korea? Sign up with phone',
  'login.regionSwitchToIntl': 'Sign up from overseas',
  ...
  'review.editBannerRejected': "This exhibition was rejected for '{reason}'. Please review the note above, edit, and re-publish.",
  'review.editBannerRejectedRepeated': "This exhibition was rejected for '{reason}'. Repeatedly rejected: {n} times. Please review the note above, edit, and re-publish.",
  ...
  'signup.linkSentSpam': "Can't find it? Check your spam folder too.",
  ...
  'login.linkSentSpam': "Can't find it? Check your spam folder too.",
