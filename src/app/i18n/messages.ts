...
/demo/reference|모의 JWT·GeoIP·이메일 템플릿·발송 조건 표`,
  ...
  'upload.groupHint':
    '소속·학과·동문 모임 등입니다. 강사 업로드 시 필수입니다. 기존 그룹명을 고르면 같은 모임으로 묶이고, 저장 시 띄어쓰기·대소문자만 정규화돼요.',
  ...
  'upload.guideStep1': '이미지를 선택하거나 드래그해서 올려주세요 (최대 10장)',
  'upload.guideReopen': '가이드 다시 보기',
  'upload.guideReopenLabel': '업로드 가이드 다시 열기',
  'upload.guideStep1Hint': '아래 영역을 클릭하거나 파일을 끌어다 놓으세요',
  ...
  'timelapse.defaultTitle': '작업 과정',
  'timelapse.sgfBadge': 'SGF 연동',
  'timelapse.emptyLine1': 'SGF 드로잉 툴에서 제작한 작품은',
  'timelapse.emptyLine2': '작업 과정 타임랩스를 감상할 수 있습니다',
  ...
  'upload.groupNamePlaceholder2': '소속 그룹이 있다면 그룹명을 입력해주세요 (선택)',
  ...
  'onboarding.phoneHint': '강사가 초대한 작품을 자동으로 연결해드려요',
  ...
  'pinComment.placeholder': '이 부분에 대한 피드백...',
  'pinComment.save': '저장',
  'confirm.cancel': '취소',
  'confirm.ok': '확인',
  'colorPalette.title': '작품 색상 팔레트',
  'colorPalette.collapse': '접기',
  'colorPalette.expand': '펼치기',
  'colorPalette.extracted': '작품에서 추출한 색상',
  'colorPalette.suggestedBg': '추천 전시 배경',
...
/demo/reference|Mock JWT, GeoIP, email templates, send-rule table`,
  ...
  'upload.groupHint':
    'Studio, class, alumni circle, etc. Required for instructor uploads. Pick an existing name to merge; spacing and case are normalized when saving.',
  'upload.cameraBlocked':
  ...
  'upload.guideStep1': 'Select or drag images (up to 10)',
  'upload.guideReopen': 'Show guide',
  'upload.guideReopenLabel': 'Reopen upload guide',
  'upload.guideStep1Hint': 'Click the area below or drag and drop your files',
  ...
  'timelapse.defaultTitle': 'Process',
  'timelapse.sgfBadge': 'SGF linked',
  'timelapse.emptyLine1': 'Works created with SGF Drawing Tool',
  'timelapse.emptyLine2': 'can be viewed as a timelapse',
  ...
  'upload.groupNamePlaceholder2': 'Group name (optional, if any)',
  ...
  'upload.guideCloseBtn': 'Close tip',
  ...
  'profile.formLinks': 'External links',
  ...
  'onboarding.phoneHint': 'Auto-links artworks invited by your instructor',
  'onboarding.phonePlaceholder': '010-0000-0000',
  ...
  'coachMark.uploadDesc':
    'Drag or select images, add a title and description, and you are ready to exhibit.',
  ...
  'pinComment.placeholder': 'Feedback on this area...',
  'pinComment.save': 'Save',
  'confirm.cancel': 'Cancel',
  'confirm.ok': 'OK',
  'colorPalette.title': 'Color Palette',
  'colorPalette.collapse': 'Collapse',
  'colorPalette.expand': 'Expand',
  'colorPalette.extracted': 'Colors extracted from the artwork',
  'colorPalette.suggestedBg': 'Suggested exhibition backgrounds',
