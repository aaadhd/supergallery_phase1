...
/demo/reference|모의 JWT·GeoIP·이메일 템플릿·발송 조건 표`,
  ...
  'review.badgeRejectedHint': '심사 기준에 맞지 않아 공개되지 않았어요. 자세한 사유는 알림을 확인해 주세요.',
  ...
  'upload.editModeToast': '작품이 수정되었어요.',
  ...
  'search.suggest5': '인물화',
  'search.suggest6': '추상',
  'profile.toastWorkPublic': '작품이 공개되었어요.',
  'profile.toastWorkPrivate': '작품이 비공개 처리되었어요.',
