...
/demo/reference|모의 JWT·이메일 템플릿·발송 조건 표`,
  ...
  'invite.notifAutoMatched': '\'{name}\' 님이 본인 작품을 골라 \'{title}\'에 들어왔어요. 잘못 연결됐다면 전시 편집에서 풀 수 있어요.',
  ...
  'invite.shareNotReady': '공개되면 알릴 수 있어요',
...
/demo/reference|Mock JWT, email templates, send-rule table`,
  ...
  'invite.notifAutoMatched': "'{name}' picked their work and joined '{title}'. If it's the wrong link, you can unlink it from the exhibition editor.",
  ...
  'invite.shareNotReady': "Once it's public, you can share",
