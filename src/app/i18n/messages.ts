...
/demo/reference|모의 JWT·이메일 템플릿·발송 조건 표`,
  ...
  'upload.hintCheckConsent': '위의 참여 작가 동의 확인을 체크해 주세요',
  ...
  'upload.step1Subtitle': '한 장부터 최대 10장까지, 그림을 업로드하여 전시를 만들어요.',
  ...
  'upload.step3SearchPlaceholder': '닉네임 검색 또는 이름 직접 입력',
  'upload.step3SearchHint': 'Proud Gallery 회원이면 닉네임을 검색하고, 회원이 아니면 작가명을 직접 입력해 주세요.',
  ...
  'upload.pieceTitleNoneHint': "작품 제목을 입력하지 않으면 '제목 없음'으로 표시돼요",
...
/demo/reference|Mock JWT, email templates, send-rule table`,
  ...
  'upload.publish': 'Submit Exhibition',
  'upload.hintCheckOriginal': 'Please check the original work confirmation above',
  'upload.hintCheckConsent': 'Please check the participating artists consent above',
  ...
  'upload.step1Subtitle': 'Upload 1 to 10 artworks to create your exhibition.',
  ...
  'upload.step3SearchPlaceholder': 'Search nickname or enter name',
  'upload.step3SearchHint': "If they're a Proud Gallery member, search by nickname. If not, enter their name directly.",
  ...
  'upload.pieceTitleNoneHint': "Works without a title will show as 'Untitled'",
