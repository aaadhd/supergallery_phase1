...
/demo/reference|Mock JWT, email templates, send-rule table`,
  ...
  'events.title': 'Events',
  'events.subtitle': 'Browse events on Proud Gallery',
  ...
  'pick.notifSelected': 'Your exhibition \'{title}\' was selected as Proud Gallery\'s Pick. Congrats!',
  ...
  'profile.removePieceConfirmDesc': 'Your work will be removed from this exhibition. This cannot be undone.',
  ...
  'footer.qaAdminEventParticipants': 'Contest participants',
  'footer.qaAdminPicks': "Proud's Pick",
  'footer.qaAdminCuration': 'Feed curation',
  'footer.qaAdminBanners': 'Banners',
  'footer.qaAdminManagedEvents': 'Contest management',
  'footer.copyright': '© {year} {name}. All rights reserved.',
