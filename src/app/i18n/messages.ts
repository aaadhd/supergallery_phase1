...
/demo/reference|모의 JWT·이메일 템플릿·발송 조건 표`,
  ...
  'onboarding.inviteNotice': '작가님이 보내주신 초대 링크로 오셨어요. 프로필 설정을 마치면 본인 작품을 직접 골라 연결할 수 있어요.',
...
/demo/reference|Mock JWT, email templates, send-rule table`,
  ...
  'onboarding.inviteNotice': 'You arrived via an invite link from a fellow artist. After you finish profile setup, you can pick the artwork that belongs to you.',
