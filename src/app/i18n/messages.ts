...
/demo/reference|모의 JWT·이메일 템플릿·발송 조건 표`,
  ...
  'profile.editPickWarnDesc': "이 전시를 수정하면 Artier's Pick 배지가 회수되고 픽 목록에서 내려갑니다. 계속하시겠어요?",
  'profile.editCurationWarnTitle': '기획전에서 내려갑니다',
  'profile.editCurationWarnDesc': '이 전시를 수정하면 현재 포함된 기획전에서 즉시 제외됩니다. 계속하시겠어요?',
  'profile.editPickAndCurationWarnDesc': "이 전시를 수정하면 Artier's Pick 배지가 회수되고 기획전에서도 즉시 제외됩니다. 계속하시겠어요?",
...
/demo/reference|Mock JWT, email templates, send-rule table`,
  ...
  'events.title': 'Events',
  'events.subtitle': 'Browse events on Artier',
  ...
  'profile.editPickWarnDesc': 'Editing this exhibition will revoke the Artier\'s Pick badge and remove it from the pick list. Continue?',
