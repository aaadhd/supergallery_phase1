...
/demo/reference|모의 JWT·GeoIP·이메일 템플릿·발송 조건 표`,
  ...
  'socialSignup.guide': '{provider} 계정이 확인되었습니다. 닉네임을 입력하고 약관에 동의하면 가입이 완료됩니다.',
  ...
  'upload.toastNonMemberInviteMixed': '초대 메시지 {sent}건 발송 / {failed}건 실패 — 전시는 정상 등록되었습니다',
  ...
  'upload.errMinShortSide800': '이미지가 너무 작습니다. 가로와 세로 모두 800픽셀 이상인 이미지를 사용해 주세요.',
  ...
  'upload.errMustIncludeSelf': '본인 작품을 한 점 이상 포함해주세요. 본인 작품 없이 전시를 올리려면 "저는 강사예요"를 체크해주세요.',
  ...
  'upload.publishedConfirmTitle': '전시가 등록되었습니다',
  'upload.publishedConfirmTitleApproved': '전시가 등록되었습니다',
  ...
  'profile.toastWorkDeleted': '작품이 삭제되었습니다.',
  'profile.toastDraftDeleted': '초안이 삭제되었습니다.',
  ...
  'confirm.cancel': '취소',
  'confirm.ok': '확인',
  'claim.title': '회원님 번호로 받은 초대가 있어요',
  'claim.description': '작가가 입력한 이름이 회원님 실명과 달라 자동 연결되지 않았어요. 본인이 맞으면 연결, 모르는 초대면 신고해주세요.',
  'claim.itemInviter': '보낸 작가: {artist}',
  'claim.itemInvitedAs': '초대 시 이름: {name}',
  'claim.accept': '네, 제 작품이에요',
  'claim.reject': '아니요, 모르는 초대',
  'claim.close': '나중에',
  'claim.accepted': '{title} 전시에 연결되었어요.',
  'claim.acceptFailed': '연결에 실패했어요. 다시 시도해주세요.',
  'claim.rejected': '{artist} 작가에게 허위 초대 신고가 접수되었어요.',
  'claim.fallbackWorkTitle': '(제목 없음)',
...
/demo/reference|Mock JWT, GeoIP, email templates, send-rule table`,
  ...
  'upload.errMinShortSide800': 'Image is too small. Both width and height must be at least 800 pixels.',
  ...
  'confirm.ok': 'OK',
  'claim.title': 'Invitations sent to your phone number',
  'claim.description': 'The name the artist entered didn\'t match your real name, so these weren\'t auto-linked. Claim if they\'re yours, or report if unknown.',
  'claim.itemInviter': 'From: {artist}',
  'claim.itemInvitedAs': 'Invited as: {name}',
  'claim.accept': 'Yes, it\'s mine',
  'claim.reject': 'No, unknown',
  'claim.close': 'Later',
  'claim.accepted': 'Linked to "{title}".',
  'claim.acceptFailed': 'Could not link. Please try again.',
  'claim.rejected': 'Reported {artist} for a false invitation.',
  'claim.fallbackWorkTitle': '(Untitled)',
