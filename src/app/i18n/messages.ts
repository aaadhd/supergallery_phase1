...
/demo/reference|모의 JWT·GeoIP·이메일 템플릿·발송 조건 표`,
  ...
  'invite.notifManualClaimed': '\'{name}\' 님이 본인 확인 후 전시 \'{title}\'의 참여 작가로 연결되었어요.',
...
/demo/reference|Mock JWT, GeoIP, email templates, send-rule table`,
  ...
  'invite.notifManualClaimed': '\'{name}\' confirmed identity and is now linked to your exhibition \'{title}\'.',
