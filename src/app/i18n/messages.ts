...
/demo/reference|모의 JWT·이메일 템플릿·발송 조건 표`,
  ...
  'upload.errGroupNeedsTwoArtists': '그룹 전시는 다른 작가가 2명 이상 있어야 해요. 참여 작가를 추가하거나 본인 작품을 포함해 주세요.',
  ...
  'upload.soloSuggestionDesc': '게시자 외 참여 작가가 2명 미만이에요. 개인 전시로 전환하는 것이 더 적합해요.',
...
/demo/reference|Mock JWT, email templates, send-rule table`,
  ...
  'upload.errGroupNeedsTwoArtists': 'Group exhibitions need at least 2 other artists. Please add more artists or include your own work.',
  ...
  'upload.soloSuggestionDesc': 'Fewer than 2 artists (excluding yourself) are assigned. A solo exhibition may be a better fit.',
