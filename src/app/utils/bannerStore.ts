...
const SEED_BANNERS: AdminBanner[] = [
  {
    ...
    imageUrl: '/images_1/나랑하루 작품전달 내용/봄나들이.JPG',
    linkUrl: '/events/1',
    startAt: '2026-05-01',
    endAt: '2026-05-31',
    isActive: true,
  },
  {
    ...
    imageUrl: '/images_1/사니수니/그림/봄봄봄_ 사니수니.jpg',
    linkUrl: '/events/2',
    startAt: '2026-05-01',
    endAt: '2026-06-30',
    isActive: true,
  },
  {
    ...
    imageUrl: '/images_1/김아흔-동그라미/경주 한바퀴.JPG',
  ...
  },
  {
    ...
    imageUrl: '/images_1/박소영_일러스트/토끼의 정원.jpg',
